# SICHELIA: Sicilian Intangible Cultural Heritage Exploration Leveraging Innovative Accessibility

SICHELIA is a project aimed at enhancing and enabling interoperability of Sicilian Intangile Cultural Heritage (ICH) open data through conversion, semantic enrichment, and transformation into NGSI-LD format, the standard for representing entities in the context of Smart Cities and the Internet of Things.
...
SICHELIA is a web application designed to explore and promote Sicily’s ICH. Through an interactive map, advanced search tools and thematic filtering features, it allows users to discover traditions, places, and cultural events distributed across the Sicilian territory.
...
This application was developed by Dahlia srl, the first spin off of the Univeristy of Naples "L'Orientale" as part of the DataHighway project:
